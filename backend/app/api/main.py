...
# Dev frontend origins; extend via QUANTUMLAB_CORS_ORIGINS (comma-separated)
# when the vite port differs (e.g. 5173 occupied by another project).
_cors_origins = os.environ.get(
    "QUANTUMLAB_CORS_ORIGINS",
